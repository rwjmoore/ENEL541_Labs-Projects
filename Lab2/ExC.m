...
[cart_gain cart_delay] = GainPhaseFFT(SimData{1}, SimData{2}(:,1), Ts, f, 500); title("cart position");
[pendulumn_gain pendulum_delay] = GainPhaseFFT(SimData{1}, SimData{2}(:,2), Ts, f, 500);title("pendulum angle");
