function sys = CartPend(DampingGain);
% generates a continuous-time state-space model of a cart and pendulum
% system 
%
%  syntax: sys = CartPend(DampingGain);
%
%  DampingGain is the scaling applied to the damping due to back EMF, 
%  used to incorporate the effects of friction in the motor/gear box, etc.
%  DampingGain = 1 (default) corresponds to an ideal model.

%
%  DTW 03/2001 -- Modified 03/16 for Quanser hardware
%              -- Modified 02/20 for PWM and DSpace
...
B = PWMgain*[0;0;b1;b2];
% incorprate the extra gain in the dSPACE D to A converters
